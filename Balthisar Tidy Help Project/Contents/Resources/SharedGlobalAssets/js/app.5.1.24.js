 ...
 * _htmlLoadSuccess.
 */
var APP_VERSION = "5.1.24"; /*! built 2017-09-08 */
define("shared/mixin/toc-item", [], function()
{
    return Em.Mixin.create(
    {
        ...
        path: function()
        {
            for (var a = [], b = this.get("parent"); b;) a.push(b), b = b.get("parent");
            return a.reverse()
        }.property("parent"),
        breadcrumb: function()
        {
    ...
    var a = "unknown",
        ...
        c = Em.Object.extend(
        {
            ...
            name: function()
            {
                ...
                return c ? "itunes-%@".fmt(c.toLowerCase()) : b ? "msie" : (c = a, $.each([/edge/i, /chrome/i, /safari/i, /opera/i, /webkit/i, /firefox/i, /msie/i], function()
                {
                    var a = navigator.userAgent.match(this);
                    return a ? (c = a[0].toLowerCase(), !1) : void 0
                }), c)
            }.property(),
            version: function()
            {
                var c = Em.get(window, "iTunes.version");
                return c ? c : b ? "11" : (c = a, $.each([/Version\/([_\.\d]+)/, /Edge\/([_\.\d]+)/, /Chrome\/([_\.\d]+)/, /WebKit\/([_\.\d]+)/, /MSIE ([_\.\d]+)/, /Firefox\/([_\.\d]+)/], function()
                {
                    var a = navigator.userAgent.match(this);
                    return a ? (c = a[0].replace(this, "$1")
                        .replace(/_/g, "."), !1) : void 0
                }), c)
            }.property(),
            os: function()
            {
            ...
            {
                var a = {};
                return location.search && $.each(location.search.substring(1)
                    .split("&"),
                    function()
                    {
                        var b = this.split("=");
            ...
            classNames: function()
            {
                ...
                {
                    var e = c + this.get("version")
                        .split(".")[0];
                    b.push(e)
                }
                return this.get("isInHelpViewer") ? (b.push("is-hv"), b.push(this.isInModernHelpViewer ? "is-modern-hv" : "is-older-hv")) : b.push("is-not-hv"), b.push(this.get("isMac") ? "is-mac-os" : "is-not-mac-os"), b.push(this.get("isMobile") ? "is-mobile" : "is-not-mobile"), b.push("ontouchstart" in document.documentElement ? "is-touch" : "is-not-touch"), b.join(" ")
            }.property(),
            ...
            {
                var a = [];
                if ("HelpViewer" in window && "preferredLanguages" in HelpViewer) try
                {
            ...
            _has3dTransform: function()
            {
                ...
                for (var d in c) void 0 !== b.style[d] && (b.style[d] = "translate3d(1px,1px,1px)", a = window.getComputedStyle(b)
                    ...
                    var d = function(b, c)
                    {
                        var d = a.scrollTop(),
                            ...
                            h = function()
                            {
                                ...
                                window.scrollTo(0, a), c > f && setTimeout(h, g)
                            };
                        h()
                    };
...
}), define("shared/topic/model", ["shared/mixin/toc-item", "shared/browser"], function(a, b)
{
    ...
    return Em.Object.extend(a, Ember.Evented,
    {
        ...
        {
            if (!a) return this._htmlLoadFailure();
            ...
            return a = a.replace(/[\W\w]*<body/, "<div")
                ...
                .replace(/((?:\.\.\/)+)(?!SharedGlobalArt\/)(?=.*?\s[0-9]x)/g, "%@".fmt(b)), a = this.preProcessAsDOM($(a))
                .prop("outerHTML"), a = a.replace(/<\/track>/g, ""), this.set("isError", !1), this.set("template", a), this.set("isLoaded", !0), this.trigger(c), this.get("templatePromise")
        },
        _htmlLoadFailure: function(a, b, c)
        {
            ...
            return this.set("isError", !0), this.set("template", e), this.set("isLoaded", !0), this.trigger(d), "HelpViewer" in window && "mtStatisticsIncrement" in window.HelpViewer && HelpViewer.mtStatisticsIncrement(1, 0, 0, 0), this.get("templatePromise")
        },
        preProcessAsDOM: function(a)
        {
            var c = this;
            a.addClass("apd-topic")
                .removeAttr("id"), a.find("h1")
                .attr(
                {
                    id: this.get("id"),
                    tabindex: "-1"
            ...
            var d = a.find(".Task > .Name"),
                e = d.parent(".Task"),
                f = e.length;
            d.attr("tabindex", "1"), 1 === f && e.addClass("SoloTask");
            var g = this.get("crossReferences");
            if (a.find(".xRef")
                .replaceWith(function(a, b)
                {
                    if (!$(this)
                        .attr("href")) return void console.warn('Found a link without an href attribute: "%@"'.fmt(b));
                    var d = $(this)
                        .attr("href")
                        .split(".")[0],
                        e = $(this)
                        .attr("href")
                        .split("#")[1],
                        f = d ? f = c.get("app.book")
                        .modelForID(d) : null,
                        h = $(this)
                        .attr("class");
                    return f ? f instanceof c.constructor ? $(this)
                        .hasClass("Section") ? b : (g.set(d, f), $(this)
                            .hasClass("Aside") && f.get("isAside") ? $(this)
                            .attr("aside", d)
                            .attr("href", "#/" + d) : d !== e ? '{{#link-to "topic" "%@" (query-params sub="%@") class="%@ subTopicLink"}}%@{{/link-to}}'.fmt(d, e, h, b) : '{{#link-to "topic" model.crossReferences.%@.routeSlug class="%@"}}%@{{/link-to}}'.fmt(d, h, b)) : (console.warn('Found cross-reference to non-Topic item "%@" (%@)'.fmt(f.name, d)), b) : void console.warn("Found cross-reference to missing model %@".fmt(d))
                }), a.find("a[href]")
                .each(function()
                {
                    var a = $(this)
                        .attr("href");
                    a.match(/^(http|help)/) && ($(this)
                        .attr("target", "_blank"), a.match(/\.mov(\?|")/) && $(this)
                        .addClass("video"))
                }), "apd-schema" === this.get("app.book.source_schema"))
            {
                ...
                e.each(function()
                    {
                        var a = $(this);
                        $name = a.find("> .Name"), $name.html('<span class="task-arrow"></span>' + $name.text()), $name.attr("aria-expanded", h), a.find(".TaskBody")
                            .attr("aria-hidden", !h)
                    }), b.isInModernHelpViewer && this.get("isLanding") && !this.get("app.book.isSingleTopicBook") && a.find("ul")
                    .append('<li><div class="toc-toggle"><a href="#">{{#if app.isTOCVisible}}{{loc "$LANDING_HIDE_TOC$"}}{{else}}{{loc "$LANDING_SHOW_TOC$"}}{{/if}}</a></div></li>')
            }
            return a
        }
    })
...
}), define("shared/book", ["shared/topic/model", "shared/section", "shared/url"], function(a, b, c)
{
    return Em.Object.extend(
    {
        ...
        init: function()
        {
            this.rewriteObjectAsModels("topics", this.get("Topic")), this.rewriteObjectAsModels("urls", c), this.rewriteObjectAsModels("sections", b), this.get("sections")
                .forEach(function(a, b)
                {
                    a.children && a.set("children", a.get("children")
                        .map(function(b)
                        {
                            var c = this.modelForID(b);
                            return c && c.set("parent", a), c
                        }, this)
                        .filter(function(a)
                        {
                            return !!a
                        }))
                }, this), this.set("toc", this.get("toc")
                    .map(this.modelForID, this)
                    .filter(this.filterTopics)), this.set("quick_links", this.get("quick_links")
                    .filter(function(a)
                    {
                        if (!a.href) return !1;
                        var b = a.href.split(".html")[0],
                            c = this.topics.get(b);
                        return c && (a.href = "#/" + b, a.title = a.title || c.get("name")), c
                    }, this));
            var a = this.get("landing");
            this.set("landing", null !== a ? this.modelForID(a) : null), this.set("copyright", this.modelForID(this.get("copyright")));
            var d = 0;
            this.topics.forEach(function(a, b)
            {
                a.get("isAside") || d++
            }), this.set("isSingleTopicBook", 1 === d), this.createLinkedTopicList()
        },
        ...
        modelForID: function(a)
        {
            ...
            return b || console.warn("Could not find topic id: %@ in topics, sections or urls.".fmt(a)), b
        },
        ...
        createLinkedTopicList: function()
        {
            ...
            {
                return !a.isUrl
            }), this.set("firstTopic", a[0]), this.set("lastTopic", a[a.length - 1]), a.forEach(function(b, c)
            {
        ...
        topicsInList: function(a)
        {
            ...
            return $.map(a, function(a)
            {
                if (!a)
                {
                    ...
                    return Em.isEmpty(b.get("app.ENVIRONMENT")) ? Em.Logger.error(c) : $("body")
                        .append('<div class="loading loading-error"><h1>Hmmm.</h1><p>' + c + "</p></div>"), !1
                }
                return "string" == typeof a && (a = b.modelForID(a)), a.children ? b.topicsInList(a.children) : a
            })
        }
    })
}), define("shared/tracking/event", ["shared/browser"], function(a)
{
    return Em.Object.extend(
    {
        ...
        {
            this._super();
            var b, c, d, e = "appleproductdocumentation",
                f = "metrics.apple.com",
                g = "securemetrics.apple.com",
                h = Em.computed.oneWay,
                i = this.getProperties(Ember.keys(this)),
                j = this.get("app");
            d = {
                events: "",
                eVar1: null,
                ...
                server: function()
                {
                    return j.get("book.title")
                        .toLowerCase()
                }.property(),
                pageName: function()
                {
                    return "%@:%@".fmt(this.get("server"), this.get("name"))
                        .toLowerCase()
                }.property(),
                channel: h("pageName"),
            ...
            }, this.set("TRACKING_VARS", d), this.set("EVENTS", c), this.set("CONFIG", b), this.setProperties(b), this.setProperties(d), this.setProperties(i)
        },
        name: "",
        eventName: function()
        {
        ...
        {
            var a = Em.keys(this.get("CONFIG"))
                .concat(Em.keys(this.get("TRACKING_VARS")));
...
}), define("shared/tracking/controller", ["shared/tracking/event"], function(a)
{
    return Ember.Controller.extend(
    {
        ...
        topicEventName: function(a)
        {
            ...
            return a.get("isAside") && (b = "aside:" + b), b
        },
        account: function()
        {
        ...
        track: function(a, b)
        {
            if (this.isEnabled && "s_gi" in window)
            {
                ...
                $.extend(c, this.get("model.resolvedProperties")), c.t(!0, "o", this.get("model.eventName"))
            }
        }.observes("model"),
        topicLoaded: function(b)
        {
            var c = b.id;
            b.get("subtopics") && (c += ":" + (b.subtopic + 1)), this.set("model", a.create(
            {
                events: "event1",
                name: b.name,
        ...
        quickTourStopAutoAdvance: function(b, c)
        {
            ...
            {
                var d = b.get("id");
                b.get("subtopics") && (d += ":" + (b.get("subtopic") + 1)), this.set("model", a.create(
                {
                    events: "event15",
        ...
        trackClick: function(b, c)
        {
            ...
            c && (d.eVar29 = c), this.set("model", a.create(d))
        },
...
}), define("shared/app/controller", ["shared/book", "shared/tracking/controller", "shared/browser"], function(a, b, c)
{
    return Ember.Controller.extend(
    {
        ...
        addLanguageAndDirection: function()
            {
                ...
                this.get("$html")
                    .attr("lang", a.get("isoCode")), this.get("$body")
                    .attr("dir", a.get("text-direction"))
        ...
        loadBook: function()
            {
                ...
                $.ajax(
                    ...
                    .fail(function(c, d, e)
                    {
                        ...
                        Em.isEmpty(f) || $(".loading")
                            .addClass("loading-error")
                            .html("<h1>Hmmm.</h1><p>This book exists...but I couldn’t find any .lproj folders.</p><p>Please contact your build engineer for assistance.</p>"), b.reject.apply(b, arguments)
        ...
        bookDidLoad: function(a, b, c)
        {
            ...
            this.set("ENVIRONMENT", d), $("html")
                .addClass(d);
            var e = a;
            e.app = this, this.set("book", this.get("Book")
                .create(e)), document.title = this.get("book.title"), this.get("USE_OMNITURE_TEST_SERVER") === !1 && !Em.isEmpty(d) && this.get("trackingController.isEnabled") && (Em.Logger.warn("Omniture data collection turned OFF for non-production environments."), Em.Logger.warn('Use "TOGGLE_OMNITURE_TEST_SERVER()" to enable data collection to the test server'))
        },
        ...
        {
            $("body")
                .toggleClass("landing-page", this.get("isOnLandingPage"))
        ...
        debugInfo: function()
        {
            Em.Logger.log("app_version: %@".fmt(APP_VERSION)), Em.Logger.log("framework: %@".fmt(this.get("framework"))), Em.Logger.log("schema: %@".fmt(this.get("book.source_schema"))), Em.Logger.log("build: %@".fmt(this.get("book.build_id"))), Em.Logger.log("locale: %@".fmt(this.get("bundle.currentLocale.isoCode"))), Em.Logger.log("title: %@".fmt(this.get("book.title"))), this.get("book.enable_tracking") ? Em.Logger.log('tracking product: "%@", platform: "%@", version: "%@"'.fmt(this.get("book.product"), this.get("book.platform"), this.get("book.version"))) : Em.Logger.log("tracking: disabled"), Em.Logger.log("feedback: %@".fmt(this.get("book.collect_feedback") ? "collect" : "do not collect"))
        },
        init: function()
        {
            this.set("$html", $("html")), this.set("$body", $("body")), this.get("$html")
                .addClass(c.get("classNames"));
            var a = "1" === c.get("params.omniture");
            return a && this.set("USE_OMNITURE_TEST_SERVER", !0), this.updateLandingPageClassNameOnBody(), this._super()
        }
    })
...
}), define("shared/topic/view", ["shared/browser"], function(a)
{
    return Em.View.extend(
    {
        ...
        waitForTemplateLoad: function()
            ...
            }.observes("content.templatePromise")
            .on("init"),
        setTemplateFromModel: function()
        {
            if (!this.get("isDestroying"))
            {
                ...
                this.set("template", Em.HTMLBars.compile(a)), this.rerender()
            }
        },
        click: function(a)
        {
            function b(b)
            {
                b || (c = window.open(b, "helpexternal"), c && a.preventDefault())
            }
            var c, d, e = $(a.target),
                f = this.get("controller.app") || this.get("app");
            if (e.is("a[aside]"))
            {
                var g = this.get("content");
                d = g.crossReferences[e.attr("aside")], this.showAside(d), a.preventDefault()
            }
            else e.is(".LinkAppleWebMovie") ? b(e.find("a[href]")
                .attr("href")) : e.is("a[href]") && "_blank" === e.attr("target") ? b(e.attr("href")) : e.is(".cur-lang") ? this.showLocalePicker() : e.hasClass("subTopicLink") && f.scrollToSubtopic();
            f.hidePanels()
        },
        updateDocumentTitle: function()
        {
            ...
            d = this.$ ? this.$()
                .find("h1")
                .text() : null, a = d || e.get("name"), b = this.get("controller.app.book.title"), c = e === this.get("controller.app.book.landing") ? b : a === b ? b : "%@ - %@".fmt(a, b), document.title = c
        },
        showAside: function(a)
        {
            this.get("controller.target")
                .transitionTo("topic", a)
        },
        ...
        {
            this._super(), "HelpViewer" in window && "mtContentAccessed" in HelpViewer && ("mtContentAccessedJSON" in HelpViewer ? HelpViewer.mtContentAccessedJSON(
                {
                    mtAccessContent:
                    {
                ...
                }) : HelpViewer.mtContentAccessed(this.get("content.id") + " " + this.get("content.name"), this.get("controller.app.book.title"))), a.get("isMobile") && this.$()
                .on("click", $.noop);
            ...
            this.$("video, audio")
                .on("timeupdate", function(a)
                {
                    ...
                    b > .75 ? $(this)
                        .trigger("passed75") : b > .5 ? $(this)
                        .trigger("passed50") : b > .25 && $(this)
                        .trigger("passed25")
                })
                .one("play", function(a)
                {
...
}), define("shared/topic/route", [], function()
{
    return Em.Route.extend(
    {
        model: function(a)
        {
            ...
            return c.get("book")
                .modelForID(b) || c.get("book.landing")
        },
        setupController: function(a, b)
        {
            var c = this.controllerFor("application");
            c.set("currentTopic", b), b.fetchTopicHTML()["finally"](function()
            {
                a.set("model", b), c.get("trackingController")
                    .topicLoaded(b)
            })
        }
    })
...
}), define("shared/locale/model", [], function()
{
    return Em.Object.extend(
    {
        ...
        fields: function()
        {
            ...
            return a.push(this.get("isoName")), a.push(this.get("name")), a.push(this.get("folder")), a
        }.property(),
        matches: function(a)
        {
            return -1 !== this.get("fields")
                .indexOf(a)
        }
    })
...
}), define("shared/bundle", ["shared/locale/model", "shared/browser", "shared/config"], function(a, b, c)
{
    ...
    return Em.Object.extend(
    {
        ...
        init: function()
        {
            var a = e.cast($.getJSON(f))
                ...
                .then(null, function()
                {
                    ...
                    return e.cast($.getJSON("%@%@/%@".fmt(f, a, g)))
                        .then(function(b)
                        {
        ...
        {
            this.set("currentLocale", b.get("locales")
                .map(this.localeForKey, this)
                .compact()
                .get(0) || this.get("locales.0"))
        }.observes("locales"),
        path: function()
        {
            return c.baseUrl + this.get("currentLocale")
                .folder + "/"
...
}), define("shared/slash-optional-location", [], function()
{
    var a = function(a)
    {
        if ("string" != typeof a) throw new Error("route is not a string");
    ...
    return Em.HashLocation.extend(
    {
        ...
        setURL: function(b)
        {
            b = "/" + a(b), this.set("location.hash", b), this.set("lastSetURL", b)
        }
    })
...
{
    return navigator.userAgent.indexOf("WebKit") >= 0 && navigator.userAgent.indexOf("Mobile") >= 0 && $("body")
        .addClass("no-hover"), Ember.Application.initializer(
        {
        ...
        }), Em.Application.extend(
        {
            init: function()
            {
                this._super(), this.register("location:slash-optional", g), this.Router.reopen(
                {
        ...
        preProcessAsDOM: function(b)
        {
            b.find("a[href]")
                .each(function()
                {
                    var b = $(this)
                        .attr("href");
                    if (!a.get("canHandleHelpAnchorLinks") && b.match(/^help:anchor/i) && $(this)
                        .replaceWith(function(a, b)
                        {
                            return b
                        }), !a.get("canHandleHelpOpenBookLinks") && b.match(/^help:openbook/i))
                    {
                        var c = $(this)
                            .parent()
                            .get(0);
                        "p" === c.tagName.toLowerCase() && c.children && 1 === c.children.length && $(this)
                            .parent()
                            .remove()
                    }
                });
            ...
            return 1 === c.length ? c.addClass("FeatureSingle") : c.length > 1 && c.each(function()
                {
                    var a = $(this)
                        .find(".FeatureBody");
                    $(this)
                        .attr("aria-expanded", "false"), a.attr("aria-hidden", !0), $(this)
                        .append('<button class="toggle-feature-btn"></button>')
                }), b.find(".itunes-link")
                .each(function()
                {
                    var a = $(this)
                    ...
                    a && b && ($(this)
                        .find("em")
                        .remove(), $(this)
                        .find("a")[0].innerHTML = "<em>" + a + "</em> " + b + '<span class="link-external"></span></a>')
                }), b.find("video")
                .wrap('<div class="video-container"></div>'), b.find(".video-container")
                .append('<button class="thumbnail"><span class="thumbnail-button">{{loc "$VIDEO_PLAY$"}}</span></button>'), this._super(b)
        }
    })
    ...
    return a.extend(
    {
        ...
        init: function()
        {
            ...
            if (this.birdseed_version < c)
            {
                ...
                if (d) return void window.location.replace(d + location.search + location.hash);
        ...
        {
            var a = this.topicsInList(this.get("toc"));
            return a[0] !== this.get("landing") && a.splice(0, 0, this.get("landing")), a = a.filter(function(a)
            {
                return !a.isUrl
            }), this.set("firstTopic", a[0]), this.set("lastTopic", a[a.length - 1]), a.forEach(function(b, c)
            {
    ...
    return Ember.HTMLBars.template(function()
    {
        var a = function()
            {
                return {
                    ...
                    render: function(a, b, c)
                    {
                        ...
                        d.detectNamespace(c);
                        var g;
                        b.useFragmentCache && d.canClone ? (null === this.cachedFragment && (g = this.build(d), this.hasRendered ? this.cachedFragment = g : this.hasRendered = !0), this.cachedFragment && (g = d.cloneNode(this.cachedFragment, !0))) : g = this.build(d);
                        var h = d.createMorphAt(d.childAt(g, [1]), 0, 0);
                        return f(b, h, a, "content.chapterName"), g
                    }
                }
            }(),
            b = function()
            {
                return {
                    ...
                    build: function(a)
                    {
                        ...
                        a.setAttribute(d, "class", "toggle-toc-btn"), a.appendChild(c, d);
                        var d = a.createElement("span");
                        a.setAttribute(d, "class", "toggle-toc-btn-label");
                        var e = a.createComment("");
                        a.appendChild(d, e), a.appendChild(c, d), a.appendChild(b, c);
                        var c = a.createTextNode("\n");
                        return a.appendChild(b, c), b
                    },
                    render: function(a, b, c)
                    {
                        ...
                        d.detectNamespace(c);
                        var j;
                        b.useFragmentCache && d.canClone ? (null === this.cachedFragment && (j = this.build(d), this.hasRendered ? this.cachedFragment = j : this.hasRendered = !0), this.cachedFragment && (j = d.cloneNode(this.cachedFragment, !0))) : j = this.build(d);
                        var k = d.childAt(j, [1]),
                            l = d.childAt(k, [1]),
            ...
            c = function()
            {
                var a = function()
                {
                    var a = function()
                        {
                            var a = function()
                            {
                                return {
                                    ...
                                    render: function(a, b, c)
                                    {
                                        ...
                                        return d.insertBoundary(g, null), d.insertBoundary(g, 0), f(b, h, a, "loc", ["$PREV_TOPIC_BUTTON_LABEL_SHORT$"],
                                        {}), g
                                    }
                                }
                            }();
                            return {
                                ...
                                render: function(b, c, d)
                                {
                                    ...
                                    e.detectNamespace(d);
                                    var i;
                                    c.useFragmentCache && e.canClone ? (null === this.cachedFragment && (i = this.build(e), this.hasRendered ? this.cachedFragment = i : this.hasRendered = !0), this.cachedFragment && (i = e.cloneNode(this.cachedFragment, !0))) : i = this.build(e);
                                    var j = e.createMorphAt(i, 0, 0, d);
                                    return e.insertBoundary(i, null), e.insertBoundary(i, 0), h(c, j, b, "link-to", ["topic", g(c, b, "content.prev")],
                                    {
                                        classNames: "prev"
                                    }, a, null), i
                                }
                        ...
                        b = function()
                        {
                            var a = function()
                            {
                                return {
                                    ...
                                    render: function(a, b, c)
                                    {
                                        ...
                                        b.useFragmentCache && d.canClone ? (null === this.cachedFragment && (g = this.build(d), this.hasRendered ? this.cachedFragment = g : this.hasRendered = !0), this.cachedFragment && (g = d.cloneNode(this.cachedFragment, !0))) : g = this.build(d);
                                        var h = d.createMorphAt(g, 0, 0, c);
                                        return d.insertBoundary(g, null), d.insertBoundary(g, 0), f(b, h, a, "loc", ["$NEXT_TOPIC_BUTTON_LABEL_SHORT$"],
                                        {}), g
                                    }
                                }
                            }();
                            return {
                                ...
                                render: function(b, c, d)
                                {
                                    ...
                                    c.useFragmentCache && e.canClone ? (null === this.cachedFragment && (i = this.build(e), this.hasRendered ? this.cachedFragment = i : this.hasRendered = !0), this.cachedFragment && (i = e.cloneNode(this.cachedFragment, !0))) : i = this.build(e);
                                    var j = e.createMorphAt(i, 0, 0, d);
                                    return e.insertBoundary(i, null), e.insertBoundary(i, 0), h(c, j, b, "link-to", ["topic", g(c, b, "content.next")],
                                    {
                                        classNames: "next"
                                    }, a, null), i
                                }
                    ...
                    return {
                        ...
                        render: function(c, d, e)
                        {
                            ...
                            f.detectNamespace(e);
                            var j;
                            d.useFragmentCache && f.canClone ? (null === this.cachedFragment && (j = this.build(f), this.hasRendered ? this.cachedFragment = j : this.hasRendered = !0), this.cachedFragment && (j = f.cloneNode(this.cachedFragment, !0))) : j = this.build(f);
                            var k = f.createMorphAt(j, 1, 1, e),
                                l = f.createMorphAt(j, 3, 3, e);
                            return i(d, k, c, "if", [h(d, c, "content.prev")],
                            {}, a, null), i(d, l, c, "if", [h(d, c, "content.next")],
                            {}, b, null), j
                        }
                    }
                }();
                return {
                    ...
                    render: function(b, c, d)
                    {
                        ...
                        c.useFragmentCache && e.canClone ? (null === this.cachedFragment && (i = this.build(e), this.hasRendered ? this.cachedFragment = i : this.hasRendered = !0), this.cachedFragment && (i = e.cloneNode(this.cachedFragment, !0))) : i = this.build(e);
                        var j = e.createMorphAt(i, 0, 0, d);
                        return e.insertBoundary(i, null), e.insertBoundary(i, 0), h(c, j, b, "if", [g(c, b, "app.book.show_previous_next")],
                        {}, a, null), i
                    }
                }
            }(),
            d = function()
            {
                var a = function()
                {
                    ...
                    return {
                        ...
                        render: function(b, c, d)
                        {
                            ...
                            c.useFragmentCache && e.canClone ? (null === this.cachedFragment && (i = this.build(e), this.hasRendered ? this.cachedFragment = i : this.hasRendered = !0), this.cachedFragment && (i = e.cloneNode(this.cachedFragment, !0))) : i = this.build(e);
                            var j = e.createMorphAt(i, 0, 0, d);
                            return e.insertBoundary(i, null), e.insertBoundary(i, 0), h(c, j, b, "if", [g(c, b, "app.doShowFeedbackForm")],
                            {}, a, null), i
                        }
                    }
                }();
                return {
                    ...
                    render: function(b, c, d)
                    {
                        ...
                        c.useFragmentCache && e.canClone ? (null === this.cachedFragment && (i = this.build(e), this.hasRendered ? this.cachedFragment = i : this.hasRendered = !0), this.cachedFragment && (i = e.cloneNode(this.cachedFragment, !0))) : i = this.build(e);
                        var j = e.createMorphAt(i, 0, 0, d);
                        return e.insertBoundary(i, null), e.insertBoundary(i, 0), h(c, j, b, "unless", [g(c, b, "content.isCopyright")],
                        {}, a, null), i
                    }
                }
            }(),
            e = function()
            {
                var a = function()
                    {
                                ...
                                var a = function()
                                {
                                    return {
                                        ...
                                        render: function(a, b, c)
                                        {
                                            ...
                                            b.useFragmentCache && d.canClone ? (null === this.cachedFragment && (g = this.build(d), this.hasRendered ? this.cachedFragment = g : this.hasRendered = !0), this.cachedFragment && (g = d.cloneNode(this.cachedFragment, !0))) : g = this.build(d);
                                            var h = d.createMorphAt(g, 0, 0, c);
                                            return d.insertBoundary(g, null), d.insertBoundary(g, 0), f(b, h, a, "app.book.copyright_text"), g
                                        }
                                    }
                                }();
                                return {
                                    ...
                                    render: function(b, c, d)
                                    {
                                        ...
                                        c.useFragmentCache && e.canClone ? (null === this.cachedFragment && (i = this.build(e), this.hasRendered ? this.cachedFragment = i : this.hasRendered = !0), this.cachedFragment && (i = e.cloneNode(this.cachedFragment, !0))) : i = this.build(e);
                                        var j = e.createMorphAt(i, 0, 0, d);
                                        return e.insertBoundary(i, null), e.insertBoundary(i, 0), h(c, j, b, "link-to", ["topic", g(c, b, "app.book.copyright")],
                                        {}, a, null), i
                                    }
                                }
                            }(),
                        ...
                        return {
                            ...
                            render: function(c, d, e)
                            {
                                ...
                                return f.insertBoundary(j, null), f.insertBoundary(j, 0), i(d, k, c, "if", [h(d, c, "app.book.copyright")],
                                {}, a, b), j
                            }
                        }
                    }(),
                ...
                return {
                    ...
                    render: function(c, d, e)
                    {
                        ...
                        return i(d, k, c, "if", [h(d, c, "content.isLanding")],
                        {}, a, b), j
                    }
                }
            }(),
                ...
                var a = function()
                {
                    return {
                        ...
                        build: function(a)
                        {
                            ...
                            a.setAttribute(e, "class", "lang-icon"), a.appendChild(d, e);
                        ...
                        render: function(a, b, c)
                        {
                            ...
                            return f(b, h, a, "app.bundle.currentLocale.name"), g
                        }
                    }
                }();
                return {
                    ...
                    render: function(b, c, d)
                    {
                        ...
                        c.useFragmentCache && e.canClone ? (null === this.cachedFragment && (i = this.build(e), this.hasRendered ? this.cachedFragment = i : this.hasRendered = !0), this.cachedFragment && (i = e.cloneNode(this.cachedFragment, !0))) : i = this.build(e);
                        var j = e.createMorphAt(i, 0, 0, d);
                        return e.insertBoundary(i, null), e.insertBoundary(i, 0), h(c, j, b, "if", [g(c, b, "app.bundle.hasMultipleLocales")],
                        {}, a, null), i
                    }
                }
            }();
        return {
            ...
            build: function(a)
            {
                ...
                a.appendChild(e, f);
                var f = a.createTextNode("    ");
                a.appendChild(e, f), a.appendChild(d, e);
                var e = a.createTextNode("\n  ");
                a.appendChild(d, e), a.appendChild(c, d);
                var d = a.createTextNode("\n");
                a.appendChild(c, d), a.appendChild(b, c);
            ...
            render: function(g, h, i)
            {
                ...
                j.detectNamespace(i);
                var q;
                h.useFragmentCache && j.canClone ? (null === this.cachedFragment && (q = this.build(j), this.hasRendered ? this.cachedFragment = q : this.hasRendered = !0), this.cachedFragment && (q = j.cloneNode(this.cachedFragment, !0))) : q = this.build(j);
                ...
                return n(h, z, r, "class", m(h, ["topic-page ", l(h, g, "view.categories")])), o(h, s, g, "unless", [l(h, g, "content.isLanding")],
                {}, a, null), p(h, t, g, "yield"), o(h, u, g, "if", [l(h, g, "content.isLanding")],
                {}, b, null), o(h, v, g, "unless", [l(h, g, "content.isLanding")],
                {}, c, null), o(h, w, g, "unless", [l(h, g, "content.isError")],
                {}, d, null), o(h, x, g, "unless", [l(h, g, "content.isCopyright")],
                {}, e, null), o(h, y, g, "unless", [l(h, g, "app.isInHelpViewer")],
                {}, f, null), q
            }
        }
    }())
    ...
    return a.extend(e,
    {
        ...
        click: function(a)
        {
            var b = $(a.target),
                ...
                d = !1;
            (b.is(".toc-toggle a") || b.is(".landing-toc-btn")) && (c.manuallyToggleTOC(), c.get("trackingController")
                .toggleTOC("event31"), d = !0);
            var e;
            if (b.is(".task-arrow, .Task > .Name") && (e = b.parents(".Task")), e && !e.hasClass("SoloTask"))
            {
                var f;
                a.altKey && (f = "false" === e.find(".Name")
                    .attr("aria-expanded"), e = $(".AppleTopic div.Task"));
                var g = this;
                e.each(function()
                {
            ...
            var h;
            b.is(".toggle-feature-btn") ? h = b.parents(".Feature") : b.parent()
                .is(".Feature[aria-expanded=false]") ? h = b.parent() : b.is(".Feature[aria-expanded=false]") && (h = b), h && this.toggleDisclosableElement(this.TYPE_PP, h, !0), b.is(".next, .prev") && c.get("trackingController")
                .nextPrev("ui"), b.is(".video-container .thumbnail") && (this.handleVideoPlayerEvents(b.parent()
                    .find("video")[0]), d = !0), d || this._super(a)
        },
        touchMove: function()
        {
        ...
        showLocalePicker: function()
        {
            this.get("controller.app.localePicker")
                .show()
        },
        toggleDisclosableElement: function(a, b, c, d)
        {
            var e = a === this.TYPE_TASK ? this.$()
                .find(".Task > .Name") : this.$()
                .find(".Feature > .Name"),
                f = b.find(".Name"),
            ...
            var k = function()
            {
                c && (g.css("transition", "max-height " + j + "ms ease-in-out, opacity 200ms " + j / 2 + "ms ease-in-out"), g.addClass("animating")), g.attr("aria-hidden", h), f.attr("aria-expanded", !h), a === this.TYPE_PP && b.attr("aria-expanded", !h)
            }.bind(this);
            c ? requestAnimationFrame(k) : k(), setTimeout(function()
            {
                g.removeClass("animating"), g.css("max-height", "unset"), h && g.css("display", "none")
            }, j);
            ...
            else
            {
                ...
                n.get("trackingController")
                    .expansion(b.attr("id"), n.get("currentTopic"), f.text(), e.index(f), a === this.TYPE_TASK ? "event17" : "event16")
            }
        },
        ...
        handleVideoPlayerEvents: function(a, b)
        {
            ...
            a && (b ? (d.text(this.STRING_REPLAY), c.attr("data-state", "ended")) : a.paused ? (a.play(), d.text(this.STRING_PAUSE), c.attr("data-state", "playing")) : (a.pause(), d.text(this.STRING_PLAY), c.attr("data-state", "paused")))
        },
        didInsertElement: function()
        {
            this._super();
            var a = this.get("controller.app");
            a.get("book.isSingleTopicBook") && this.$(".landing")
                .removeClass("landing");
            var b = Math.floor(569 * .8),
                d = parseInt(this.$(".landing img")
                    .width(), 10);
            this.$(".AppleTopic.landing figure")
                .css("min-width", "%@px".fmt(Math.min(b, d))), this.updateDocumentTitle(), this.restoreTaskState(), this.restoreFeatureState(), this.$() && this.$()
                .find("h1")
                .focus(), c.isTablet && this.set("scrollFix", new ScrollFix(this.get("element"))), this.$(".PassionPoints .Feature a[href].xRef")
                .one("click", function(b)
                {
                    var c = $(b.target);
                    a.get("trackingController")
                        .trackPassionPointClick(a.get("currentTopic"), c.text(), c.attr("href")
                            .split("#/")[1])
                }), this.$(".landing-toc-btn")
                .detach()
                .insertAfter(".PassionPoints .Hero"), this.$("video")
                .attr("controls", !1);
            var e = this;
            this.$("video")
                .bind("ended", function(a)
                {
        ...
        willDestroyElement: function()
        {
            ...
            a && a.destroy(), this.$(".PassionPoints .Feature a[href].xRef")
                .off()
        }
    })
    ...
    return Ember.HTMLBars.template(function()
    {
        return {
            ...
            render: function(a, b, c)
            {
                ...
                d.detectNamespace(c);
                var h;
                b.useFragmentCache && d.canClone ? (null === this.cachedFragment && (h = this.build(d), this.hasRendered ? this.cachedFragment = h : this.hasRendered = !0), this.cachedFragment && (h = d.cloneNode(this.cachedFragment, !0))) : h = this.build(d);
                var i = d.childAt(h, [2]),
                ...
                return f(b, j, a, "view.headerLabel"), g(b, k, a, "loc", ["$MODAL_CLOSE_BUTTON$"],
                {}), f(b, l, a, "yield"), g(b, m, a, "loc", ["$MODAL_CLOSE_BUTTON$"],
                {}), h
            }
        }
    }())
}), define("component/modal", ["precompiled/component/modal", "shared/computed"], function(a, b)
{
    return Em.Mixin.create(
    {
        ...
        click: function(a)
        {
            var b = $(a.target);
            (this.$()
                .is(a.target) || b.is("[name=close]")) && this.dismiss(), this._super(a)
        },
        show: function()
        {
            this.$()
                .toggleClass("has-modal-header", !Em.isEmpty(this.get("headerLabel"))), this.set("$previousFocus", $(":focus")), this.set("isVisible", !0), $("html")
                .addClass("modal-view")
        },
        dismiss: function()
        {
            var a = this.$();
            a && this.get("isVisible") && (a.addClass("dismiss"), Em.run.later(this, function()
            {
                this.set("isVisible", !1), this.get("$previousFocus") && this.get("$previousFocus")
                    .focus(), this.set("$previousFocus", null), a.removeClass("dismiss"), $("html")
    ...
    return Ember.HTMLBars.template(function()
    {
        return {
            ...
            render: function(a, b, c)
            {
                ...
                {}), g(b, j, a, "yield"), f(b, k, a, "loc", ["$MODAL_CLOSE_BUTTON$"],
                {}), h
            }
        }
    }())
}), define("aside/view", ["topic/view", "component/modal", "precompiled/aside/layout", "shared/base/controller", "shared/browser"], function(a, b, c, d, e)
{
    return a.extend(b,
    {
        ...
        didInsertElement: function()
        {
            this._super(), e.get("isMobile") && this.set("scrollFix", new ScrollFix(this.$(".modal-content")[0]))
        },
        willDestroyElement: function()
        {
            e.get("isMobile") && this.get("scrollFix")
                .destroy()
        },
        dismiss: function()
        {
            this.set("controller.content", null), this._super()
        },
        showTopic: function(a)
        {
            ...
            {
                b.set("template", Em.Handlebars.compile(a.template)), b.set("content", a), b.rerender(), b.show(), b.get("controller.app.trackingController")
                    .topicLoaded(a)
            })
        },
        updateDocumentTitle: function()
        ...
        var a = function()
        {
            return {
                ...
                render: function(a, b, c)
                {
                    ...
                    return h(b, m, k, "data-value", g(b, [f(b, a, "locale.isoCode")])), i(b, l, a, "locale.name"), j
                }
            }
        }();
        return {
...
}), define("locale/select-view", ["component/modal", "precompiled/locale/select-view", "shared/computed"], function(a, b, c)
{
    return Em.View.extend(a,
    {
        ...
        click: function(a)
        {
            ...
            var b = $(a.target),
                c = b.attr("data-value");
            c && (location.search = "lang=%@".fmt(c), this.dismiss())
        }
    })
    ...
    var d = function(b)
        {
            if (!b.matches || b.matches.length < 1)
            {
                b.matches = [];
                var c = b[idKey];
                for (var d in c) b.matches.push(a.create(
                {
                    topic: this.get("app.book")
                        .modelForID(d),
                    weight: c[d]
                }));
                delete b[idKey]
        ...
        i = Em.Object.extend(
        {
            ...
            nodesForQuery: function(a)
            {
                ...
                var h = [].concat(f.nodesForQuery(d)),
                    i = h[h.length - 1];
                return i && i[childrenKey] && i[childrenKey][e] ? h[h.length - 1] = i[childrenKey][e] : f.noWordBoundaries ? h.push(b()) : "." === e ? h.push(f.get("searchTree")) : f.shouldIgnoreString(e) || (h[h.length - 1] = g), h
            },
...
}), define("app/controller", ["shared/app/controller", "book", "aside/view", "locale/select-view", "search/index-model", "shared/browser", "shared/base/controller"], function(a, b, c, d, e, f, g)
{
    return a.extend(
    {
        ...
        doShowMoreHelpLink: function()
        {
            ...
            return $("body")
                .toggleClass("show-more-help-link", a), a
        ...
        updateSingleTopicBookClassNameOnBody: function()
            {
                this.get("book.isSingleTopicBook") && $("body")
                    .addClass("single-page-book")
            }.observes("book")
            .on("init"),
        updateHelpViewerTOCButton: function()
            {
                if (f.isInModernHelpViewer)
                    if (this.get("book.isSingleTopicBook")) HelpViewer.showTOCButton(!1), this.set("isTOCVisible", !1);
                    else
                    {
        ...
        hidePanels: function()
        {
            this._super(), f.isInModernHelpViewer || (!this.get("isPersistentTOC") && this.get("isTOCVisible") && this.toggleTOC(), this.set("isSearchVisible", !1))
        },
        manuallyToggleTOC: function()
        {
            this.toggleTOC(), this.set("disablePersistentTOC", !this.get("isTOCVisible"))
        },
        toggleTOC: function()
        {
            ...
            {
                $("html")
                    .addClass("toc-animating");
                var a = this.toggleProperty("isTOCVisible");
                if (Em.run.later(function()
                    {
                        $("html")
                            .removeClass("toc-animating")
                    }, 300), f.isInModernHelpViewer)
                {
                    try
                    {
        ...
        {
            this.get("isSearchVisible") ? (this.get("isPersistentTOC") || this.set("isTOCVisible", !1), this.focusSearch(), this.animateTransitionClass("#header-content", "searchshow")) : (this.blurSearch(), this.animateTransitionClass("#header-content", "searchhide"), this.clearSearch())
        }.observes("isSearchVisible"),
        animateTransitionClass: function(a, b, c)
        {
            c = c || 1e3, Ember.run.later(this, function()
            {
                $(a)
                    .addClass(b)
            }, 0), Ember.run.later(this, function()
            {
                $(a + "." + b)
                    .removeClass(b)
            }, c)
        ...
        {
            this.get("$html")
                .toggleClass("panel-visible", this.get("isTOCVisible") && !this.get("isPersistentTOC") || this.get("isSearchVisible"))
        ...
        {
            var b = $("#" + a);
            if (b && b.get(0) && ("msie" === f.get("name") ? b.scrollintoview() : b.get(0)
                    .scrollIntoView(), b.hasClass("Task")))
            {
                var c = b.children()
                    .first();
        ...
        performSearch: function()
        {
            ...
            {
                var a, b;
                a = this.get("searchString"), prevSearch = this.get("searchResult.query"), a !== prevSearch && (a && a.length > 1 && (b = this.get("searchIndex")
                    .resultForQuery(a), this.get("trackingController")
                    .performSearch(b)), this.set("searchResult", b))
            }
        },
        ...
        commitSearch: function()
        {
            ...
            a.debounceSearch(), a.blurSearch()
        },
        clearSearch: function()
        {
            this.set("searchResult", null), this.set("searchString", "")
        },
        ...
        {
            $("html")
                .toggleClass("fka-styles", this.get("useFKAStyles"))
        ...
        init: function()
        {
            ...
            $(window)
                ...
                {
                    a.blurSearch(), a.hidePanels(), a.get("aside")
                        .dismiss()
                }), f.isInHelpViewer || f.get("isMobile") || $(window)
                .on("resize", function()
                {
                    a.updateWindowSize()
                }), $(window)
                ...
                .keydown(function(b)
                {
                        ...
                        .is("input, textarea"))
                    {
                        ...
                        switch ((b.metaKey || b.ctrlKey) && (m = !0), b.keyCode || b.which)
                        {
                            case f:
                                a.hidePanels(), k.dismiss(), l.dismiss();
                                break;
                            case g:
                                break;
                            case i:
                                d && !m && (a.transitionToRoute("topic", d.get("routeSlug")), a.get("trackingController")
                                    .nextPrev("key"));
                                break;
                            case j:
                                e && !m && (a.transitionToRoute("topic", e.get("routeSlug")), a.get("trackingController")
                                    .nextPrev("key"));
                                break;
                            case h:
            ...
            var b = this.get("$body");
            b.addClass("loaded-timer"), Em.run.later(this, function()
            {
    ...
    return Ember.HTMLBars.template(function()
    {
        var a = function()
            {
                return {
                    ...
                    build: function(a)
                    {
                        ...
                        var e = a.createElement("a"),
                            f = a.createComment("");
                        a.appendChild(e, f), a.appendChild(d, e), a.appendChild(c, d);
                        var d = a.createTextNode("\n 	");
                        a.appendChild(c, d);
                        var d = a.createElement("li"),
                    ...
                    render: function(a, b, c)
                    {
                        ...
                        d.detectNamespace(c);
                        var k;
                        b.useFragmentCache && d.canClone ? (null === this.cachedFragment && (k = this.build(d), this.hasRendered ? this.cachedFragment = k : this.hasRendered = !0), this.cachedFragment && (k = d.cloneNode(this.cachedFragment, !0))) : k = this.build(d);
                        var l = d.childAt(k, [1]),
                            m = d.childAt(l, [1]),
                            n = d.childAt(m, [2]),
                            o = d.childAt(l, [3]),
            ...
            d = function()
            {
                return {
                    ...
                    render: function(a, b, c)
                    {
                        ...
                        d.detectNamespace(c);
                        var l;
                        b.useFragmentCache && d.canClone ? (null === this.cachedFragment && (l = this.build(d), this.hasRendered ? this.cachedFragment = l : this.hasRendered = !0), this.cachedFragment && (l = d.cloneNode(this.cachedFragment, !0))) : l = this.build(d);
                        var m = d.childAt(l, [1]),
        ...
        return {
            ...
            render: function(f, g, h)
            {
                ...
                i.detectNamespace(h);
                var o;
                g.useFragmentCache && i.canClone ? (null === this.cachedFragment && (o = this.build(i), this.hasRendered ? this.cachedFragment = o : this.hasRendered = !0), this.cachedFragment && (o = i.cloneNode(this.cachedFragment, !0))) : o = this.build(i);
                var p = i.childAt(o, [4]),
                ...
                return i.insertBoundary(o, null), i.insertBoundary(o, 0), l(g, q, f, "if", [k(g, f, "doShowDebugPane")],
                {}, a, null), l(g, r, f, "unless", [k(g, f, "isHeaderDisabled")],
                {}, b, null), l(g, s, f, "unless", [k(g, f, "isTOCDisabled")],
                {}, c, null), m(g, t, f, "outlet"), l(g, u, f, "if", [k(g, f, "doShowAlternateTOCButton")],
                {}, d, null), n(g, v, f, "view", [k(g, f, "aside")],
                {}), l(g, w, f, "unless", [k(g, f, "isInHelpViewer")],
                {}, e, null), o
            }
        }
    }())
    ...
    return Ember.HTMLBars.template(function()
    {
            ...
            d = function()
            {
                return {
                    ...
                    build: function(a)
                    {
                        ...
                        a.appendChild(b, c);
                        var c = a.createElement("button");
                        a.setAttribute(c, "class", "searchview-close"), a.setAttribute(c, "name", "find"), a.setAttribute(c, "type", "button"), a.setAttribute(c, "role", "checkbox");
                        var d = a.createTextNode("\n		  ");
                        a.appendChild(c, d);
                        var d = a.createElement("span");
                        ...
                        a.appendChild(d, e);
                        var e = a.createElement("span");
                        a.setAttribute(e, "class", "searchview-close-left"), a.appendChild(d, e);
                        var e = a.createTextNode("\n		    ");
                        a.appendChild(d, e);
                        var e = a.createElement("span");
                        a.setAttribute(e, "class", "searchview-close-right"), a.appendChild(d, e);
                        var e = a.createTextNode("\n		  ");
                        a.appendChild(d, e), a.appendChild(c, d);
                        var d = a.createTextNode("\n		");
                        a.appendChild(c, d), a.appendChild(b, c);
        ...
        return {
            ...
            build: function(a)
            {
                ...
                a.appendChild(c, d);
                var d = a.createElement("button");
                a.setAttribute(d, "name", "toc"), a.setAttribute(d, "type", "button"), a.setAttribute(d, "role", "checkbox");
                var e = a.createTextNode("\n");
                a.appendChild(d, e);
                var e = a.createComment("");
                a.appendChild(d, e);
            ...
            render: function(e, f, g)
            {
                ...
                h.detectNamespace(g);
                var o;
                f.useFragmentCache && h.canClone ? (null === this.cachedFragment && (o = this.build(h), this.hasRendered ? this.cachedFragment = o : this.hasRendered = !0), this.cachedFragment && (o = h.cloneNode(this.cachedFragment, !0))) : o = this.build(h);
                var p = h.childAt(o, [0]),
                    q = h.childAt(p, [1]),
                    r = h.childAt(p, [3]),
                ...
                {})])), n(f, t, e, "if", [j(f, e, "isTOCVisible")],
                {}, a, b), m(f, x, r, "class", l(f, [k(f, e, "if", [j(f, e, "isSearchVisible"), "searchopen", ""],
                {})])), n(f, w, e, "link-to", ["index"],
                {}, c, null), n(f, y, e, "unless", [j(f, e, "isSearchDisabled")],
                {}, d, null), o
            }
        }
    }())
}), define("header/view", ["precompiled/header/template", "shared/computed"], function(a, b)
{
    return Em.View.extend(
    {
        ...
        {
            var b = $(a.target);
            b.is("[name=toc]") ? (this.get("controller")
                    .manuallyToggleTOC(), this.get("controller.trackingController")
                    .toggleTOC("event32")) : b.is("[name=find]") || b.is('[class^="searchview-close"]') ? this.get("controller")
                .toggleSearch() : b.is("a[href]") && (location.href = b.attr("href"), a.preventDefault()), this._super(a)
        },
    ...
    return Ember.HTMLBars.template(function()
    {
        var a = function()
            {
                var a = function()
                {
                    var a = function()
                    {
                        var a = function()
                        {
                                ...
                                var a = function()
                                    {
                                        return {
                                            ...
                                            render: function(a, b, c)
                                            {
                                                ...
                                                b.useFragmentCache && d.canClone ? (null === this.cachedFragment && (g = this.build(d), this.hasRendered ? this.cachedFragment = g : this.hasRendered = !0), this.cachedFragment && (g = d.cloneNode(this.cachedFragment, !0))) : g = this.build(d);
                                                var h = d.createMorphAt(g, 1, 1, c);
                                                return f(b, h, a, "topic.searchName"), g
                                            }
                                        }
                                    }(),
                                    b = function()
                                    ...
                                    c = function()
                                    {
                                        return {
                                            ...
                                            render: function(a, b, c)
                                            {
                                                ...
                                                b.useFragmentCache && d.canClone ? (null === this.cachedFragment && (g = this.build(d), this.hasRendered ? this.cachedFragment = g : this.hasRendered = !0), this.cachedFragment && (g = d.cloneNode(this.cachedFragment, !0))) : g = this.build(d);
                                                var h = d.createMorphAt(d.childAt(g, [1]), 0, 0);
                                                return f(b, h, a, "topic.breadcrumb"), g
                                            }
                                        }
                                    }();
                                return {
                                    ...
                                    render: function(d, e, f)
                                    {
                                        ...
                                        g.detectNamespace(f);
                                        var k;
                                        e.useFragmentCache && g.canClone ? (null === this.cachedFragment && (k = this.build(g), this.hasRendered ? this.cachedFragment = k : this.hasRendered = !0), this.cachedFragment && (k = g.cloneNode(this.cachedFragment, !0))) : k = this.build(g);
                                        var l = g.createMorphAt(k, 0, 0, f),
                                            m = g.createMorphAt(k, 1, 1, f);
                                        return g.insertBoundary(k, null), g.insertBoundary(k, 0), j(e, l, d, "if", [i(e, d, "topic.searchName")],
                                        {}, a, b), j(e, m, d, "if", [i(e, d, "topic.breadcrumb")],
                                        {}, c, null), k
                                    }
                                }
                            }();
                            return {
                                ...
                                build: function(a)
                                {
                                    ...
                                    a.appendChild(b, c);
                                    var c = a.createElement("li");
                                    a.setAttribute(c, "role", "option"), a.setAttribute(c, "class", "searchresults-item searchresults-animated");
                                    var d = a.createTextNode("\n");
                                    a.appendChild(c, d);
                                    var d = a.createComment("");
                                    a.appendChild(c, d);
                        ...
                        return {
                            ...
                            render: function(b, c, d)
                            {
                                ...
                                c.useFragmentCache && e.canClone ? (null === this.cachedFragment && (i = this.build(e), this.hasRendered ? this.cachedFragment = i : this.hasRendered = !0), this.cachedFragment && (i = e.cloneNode(this.cachedFragment, !0))) : i = this.build(e);
                                var j = e.createMorphAt(i, 0, 0, d);
                                return e.insertBoundary(i, null), e.insertBoundary(i, 0), h(c, j, b, "if", [g(c, b, "topic.name")],
                                {}, a, null), i
                            }
                        }
                    }();
                    return {
                        ...
                        render: function(b, c, d)
                        {
                            ...
                            c.useFragmentCache && e.canClone ? (null === this.cachedFragment && (i = this.build(e), this.hasRendered ? this.cachedFragment = i : this.hasRendered = !0), this.cachedFragment && (i = e.cloneNode(this.cachedFragment, !0))) : i = this.build(e);
                            var j = e.createMorphAt(i, 0, 0, d);
                            return e.insertBoundary(i, null), e.insertBoundary(i, 0), h(c, j, b, "each", [g(c, b, "view.app.searchResult.sortedTopics")],
                            {
                                keyword: "topic"
                            }, a, null), i
                        }
                ...
                return {
                    ...
                    build: function(a)
                    {
                        ...
                        a.setAttribute(d, "class", "searchresults-header searchresults-animated"), a.setAttribute(d, "role", "status");
                        var e = a.createComment("");
                        a.appendChild(d, e), a.appendChild(c, d);
                        var d = a.createTextNode("\n	            ");
                        a.appendChild(c, d);
                        var d = a.createElement("ul");
                        a.setAttribute(d, "class", "searchresults-list"), a.setAttribute(d, "role", "listbox");
                        var e = a.createTextNode("\n");
                        a.appendChild(d, e);
                        var e = a.createComment("");
                        a.appendChild(d, e);
                    ...
                    render: function(b, c, d)
                    {
                        ...
                        e.detectNamespace(d);
                        var j;
                        c.useFragmentCache && e.canClone ? (null === this.cachedFragment && (j = this.build(e), this.hasRendered ? this.cachedFragment = j : this.hasRendered = !0), this.cachedFragment && (j = e.cloneNode(this.cachedFragment, !0))) : j = this.build(e);
                        var k = e.childAt(j, [1]),
                            l = e.createMorphAt(e.childAt(k, [1]), 0, 0),
                            m = e.createMorphAt(e.childAt(k, [3]), 1, 1);
                        return g(c, l, b, "view.searchCountSummary"), i(c, m, b, "if", [h(c, b, "view.app.searchResult.sortedTopics")],
                        {}, a, null), j
                    }
                }
            }(),
            b = function()
            {
                    ...
                    var a = function()
                    {
                        return {
                            ...
                            build: function(a)
                            {
                                ...
                                a.appendChild(b, c);
                                var c = a.createElement("li");
                                a.setAttribute(c, "role", "option"), a.setAttribute(c, "class", "searchresults-item searchresults-animated searchresults-quicklink");
                                var d = a.createTextNode("\n                    ");
                                a.appendChild(c, d);
                            ...
                            render: function(a, b, c)
                            {
                                ...
                                return h(b, m, k, "href", g(b, [f(b, a, "quickLink.href")])), i(b, l, a, "quickLink.title"), j
                            }
                        }
                    }();
                    return {
                ...
                return {
                    ...
                    render: function(b, c, d)
                    {
                        ...
                        c.useFragmentCache && e.canClone ? (null === this.cachedFragment && (i = this.build(e), this.hasRendered ? this.cachedFragment = i : this.hasRendered = !0), this.cachedFragment && (i = e.cloneNode(this.cachedFragment, !0))) : i = this.build(e);
                        var j = e.createMorphAt(i, 0, 0, d);
                        return e.insertBoundary(i, null), e.insertBoundary(i, 0), h(c, j, b, "if", [g(c, b, "view.app.book.quick_links")],
                        {}, a, null), i
                    }
                }
            }();
        return {
            ...
            build: function(a)
            {
                ...
                a.setAttribute(e, "class", "searchview"), a.setAttribute(e, "role", "search");
                var f = a.createTextNode("\n      ");
                a.appendChild(e, f);
                ...
                a.setAttribute(i, "class", "searchform-icon"), a.appendChild(h, i);
                var i = a.createTextNode("\n          ");
                a.appendChild(h, i), a.appendChild(g, h);
                var h = a.createTextNode("\n        ");
                a.appendChild(g, h), a.appendChild(f, g);
                var g = a.createTextNode("\n        ");
                a.appendChild(f, g);
                ...
                a.appendChild(b, c);
                var c = a.createElement("div");
                a.setAttribute(c, "id", "search-curtain"), a.setAttribute(c, "class", "search-curtain"), a.appendChild(b, c);
                var c = a.createTextNode("\n");
                return a.appendChild(b, c), b
            },
            render: function(c, d, e)
            {
                ...
                f.detectNamespace(e);
                var n;
                d.useFragmentCache && f.canClone ? (null === this.cachedFragment && (n = this.build(f), this.hasRendered ? this.cachedFragment = n : this.hasRendered = !0), this.cachedFragment && (n = f.cloneNode(this.cachedFragment, !0))) : n = this.build(f);
                ...
                {})])), m(d, r, c, "if", [h(d, c, "view.app.searchResult")],
                {}, a, b), n
            }
        }
    }())
}), define("shared/ax/tabindex-manager", [], function()
{
    return Em.Object.extend(
    {
        ...
        updateCurrentFocus: function()
        {
            ...
            if (a && a.setAttribute)
            {
                a.setAttribute("tabIndex", 0), a.setAttribute("aria-selected", "true"), a.focus();
                var b = a.getAttribute("id"),
                    c = this.get("rootNode");
                c && c.setAttribute && c.setAttribute("aria-activedescendant", b)
            }
            else Em.Logger.warn("couldn't set the tabindex prop of axFocus ", a)
        }.observes("axFocus"),
        clearPreviousFocus: function()
        {
            var a = this.get("axFocus");
            a && a.setAttribute && (a.setAttribute("tabIndex", -1), a.setAttribute("aria-selected", "false"), a.blur())
...
}), define("search/view", ["precompiled/search/template", "shared/ax/tabindex-manager", "shared/computed", "shared/browser"], function(a, b, c, d)
{
    var e = Em.TextField.extend(
    {
        ...
        init: function()
        {
            this._super(), this.set("placeholder", c.loc("$SEARCH_BOOK_LABEL$", this.get("app.book.title")))
        }
    });
    return Em.View.extend(
    {
        ...
        init: function()
        {
            this._super(), this.set("tabIndexManager", b.create()), this.set("tabIndexManager.rootNode", this.$())
        },
        searchCountSummary: function()
        {
            var a = this.get("app.searchResult"),
                b = a ? a.get("sortedTopics")
                .length : 0,
                c = a ? a.get("query") : "",
        ...
        willDestroyElement: function()
        {
            d.get("isMobile") && this.get("scrollFix")
                .destroy()
        },
        keyPress: function(a)
        {
            13 === a.charCode && (this.get("app")
                .commitSearch(), a.preventDefault())
        },
        touchMove: function(a)
        {
            var b = $(a.target);
        ...
        keyDown: function(a)
        {
            var b = (this.get("tabIndexManager.axFocus"), "rtl" === this.get("controller.bundle.currentLocale.text-direction")),
                c = 38,
                d = 40,
                e = b ? 39 : 37,
                f = b ? 37 : 39,
                ...
                .is("input") || g !== e && g !== f)
            {
                switch (g)
                {
                    case e:
                    case c:
                        this.tabFocusToPrevious(), a.preventDefault();
                        break;
                    case f:
                    case d:
                        this.tabFocusToNext(), a.preventDefault();
                        break;
                    default:
                        this._super(a)
                }
        ...
        tabFocusToNext: function()
        {
            var a = this.get("tabFocusedResultIndex") + 1,
                b = this.$("a[href]")
                .get(a);
            b && (this.set("tabFocusedResultIndex", a), this.set("tabIndexManager.axFocus", b))
        },
        ...
        clearFocusedResultIndex: function()
        {
            ...
            var a = this.$("a[href].active"),
                b = this.$("a[href]")
                .index(a);
            this.set("tabFocusedResultIndex", b || -1), this.set("tabIndexManager.axFocus", a || void 0)
        ...
        click: function(a)
        {
            ...
            if (d.is("a[href]"))
            {
                if (this.$(".search-results .list a")
                    .removeClass("active"), d.addClass("active"), d.parent()
                    .is(".searchresults-item"))
                {
                    var e = this.get("app.trackingController"),
                        f = d.parent()
                        .is(".searchresults-quicklink");
                    f ? e.searchQuickLinkSelect(d.text(), d.attr("href")
                        .split("#/")[1]) : (b = this.get("app.searchResult"), c = this.$("a[href]")
                        .index(d), e.searchResultSelect(b, c))
                }
                Em.run.later(this, function()
                {
                    location.href = d.attr("href"), this.get("app")
                        .hidePanels()
                }, 50), a.preventDefault()
            }
            else d.is("#search-curtain") && this.get("app")
                .toggleSearch();
            this._super(a)
        }
    })
        ...
        var a = function()
        {
            return {
                ...
                render: function(a, b, c)
                {
                    ...
                    return f(b, h, a, "moreHelpLabel"), g
                }
            }
        }();
        return {
            ...
            render: function(b, c, d)
            {
                ...
                c.useFragmentCache && e.canClone ? (null === this.cachedFragment && (i = this.build(e), this.hasRendered ? this.cachedFragment = i : this.hasRendered = !0), this.cachedFragment && (i = e.cloneNode(this.cachedFragment, !0))) : i = this.build(e);
                var j = e.createMorphAt(i, 0, 0, d);
                return e.insertBoundary(i, null), e.insertBoundary(i, 0), h(c, j, b, "if", [g(c, b, "doShowMoreHelpLink")],
                {}, a, null), i
            }
        }
    }())
}), define("toc/helpers/elementClass", [], function()
{
    return {
        ...
        remove: function(a, b)
        {
            a.classList ? a.classList.remove.apply(a.classList, b.split(" ")) : a.className = a.className.replace(new RegExp("(^|\\b)" + b.split(" ")
                .join("|") + "(\\b|$)", "gi"), " ")
        },
        contains: function(a, b)
        {
            return a.classList ? a.classList.contains(b) : new RegExp("(^| )" + b + "( |$)", "gi")
                .test(a.className)
        }
    }
}), define("toc/helpers/createSection", ["toc/helpers/elementClass"], function(a)
{
    ...
    return function(c, d)
    {
        ...
        {
            var k = b("img");
            k.setAttribute("src", j), k.setAttribute("alt", ""), a.add(k, "icon"), h.appendChild(k), a.add(e, "hasIcon")
        }
        return e.setAttribute("aria-expanded", "false"), e.setAttribute("role", "treeitem"), a.add(f, "section"), a.add(g, "disclosure-icon"), a.add(h, "name"), i.setAttribute("aria-hidden", "true"), i.setAttribute("role", "group"), i.setAttribute("role", "group"), i.style.maxHeight = "0", c.get("allChildrenHaveIcons") && a.add(i, "hasIcons"), h.appendChild(document.createTextNode(c.get("name"))), [g, h].forEach(f.appendChild.bind(f)), [f, i].forEach(e.appendChild.bind(e)), e
    }
}), define("toc/helpers/createItem", ["toc/helpers/elementClass"], function(a)
{
    function b()
    {
        return "HelpViewer" in window && "mtStatisticsIncrement" in HelpViewer && HelpViewer.mtStatisticsIncrement(0, 0, 1, 0), !0
    }
    ...
    return function(e)
    {
        ...
        {
            var j = c("img");
            j.setAttribute("src", i), j.setAttribute("alt", ""), a.add(j, "icon"), h.appendChild(j), a.add(f, "hasIcon")
        }
        f.setAttribute("aria-selected", "false"), f.setAttribute("role", "treeitem");
        var k = e.get("id"),
            l = e.get("href");
        return g.setAttribute("href", d.test(l) ? l : "#/" + k), g.id = "toc-item-" + k, a.add(h, "name"), g.onClick = b, h.appendChild(document.createTextNode(e.get("name"))), g.appendChild(h), f.appendChild(g), f
    }
    ...
    var d = document.createElement.bind(document),
        e = function(f)
        {
            ...
            return f.forEach(function(d)
            {
                ...
                {
                    if (!c.get("canHandleHelpAnchorLinks") && d.href && d.href.match(/^help:anchor/i)) return;
                    if (!c.get("canHandleHelpOpenBookLinks") && d.href && d.href.match(/^help:openbook/i)) return;
                    f = b(d)
                }
                g.appendChild(f)
            }), g
...
}), define("toc/helpers/navigation", ["toc/helpers/elementClass"], function(a)
{
    function b(b, c)
    {
        for (var d = []; !(c && b === c.parentElement || "UL" === b.tagName && a.contains(b, "toc"));) d.push(b), b = b.parentElement;
        return d
    }
    ...
    function c(a, c)
    {
        ...
        f.forEach(function(b)
        {
            var f = "LI" === b.tagName,
                h = "UL" === b.tagName;
            if (f) b.setAttribute("aria-expanded", e);
            else if (h)
            {
                var i = !1;
                c && a !== b && "false" === b.getAttribute("aria-hidden") && (i = !0), i || (b.setAttribute("aria-hidden", d), g += b.scrollHeight, $(b)
                    .css("max-height", c ? "0px" : g), setTimeout(function()
                    {
                        $(b)
                            .addClass("animating"), $(b)
                            .css("max-height", c ? g : "0px")
                    }, 0), setTimeout(function()
                    {
                        $(b)
                            .removeClass("animating"), $(b)
                            .css("max-height", c ? "" : "0px")
                    }, 300))
            }
        })
    }
    ...
    var e = function(a)
        ...
        f = function(b)
        {
            if (b && !a.contains(b, "active"))
            {
                ...
                d(c) || e(c), c.firstChild === b.parentElement && a.add(c.parentElement, "first-toc-item-active"), a.add(b, "active")
            }
        },
        g = function(b)
        {
            ...
            {
                var c = b.parentElement.parentElement;
                c.firstChild === b.parentElement && a.remove(c.parentElement, "first-toc-item-active"), a.remove(b, "active")
            }
        };
    return {
        toggleSection: e,
...
}), define("toc/view", ["precompiled/toc/template", "shared/ax/tabindex-manager", "shared/computed", "toc/helpers/createList", "toc/helpers/navigation", "toc/helpers/elementClass", "shared/browser"], function(a, b, c, d, e, f, g)
{
    ...
    {
        var b = $(a);
        return b.hasClass("section") && b.siblings("ul")
            .hasClass("expanded")
    }

    function o(a, b)
    {
        for (var c = a; n(c) && h(c);) c = b(c);
        return c
    }
    ...
    return Em.View.extend(
    {
        ...
        willInsertElement: function()
        {
            var a = this,
                ...
                c = d(b);
            f.add(c, "toc scroll hasIcons"), c.setAttribute("aria-hidden", "false"), c.setAttribute("role", "tree");
            var e = this.get("element");
            e.insertBefore(c, e.firstChild), this.set("tocEl", c)
        },
        didInsertElement: function()
        {
            var a = g.get("isMobile"),
                ...
                i = 0,
                j = this;
            this.set("isMobile", a), this.set("scrollDuration", a ? 400 : 200), this.set("scrollTimeout", 400 + this.get("scrollDuration")), this.currentTopicObserver(), a && (this.set("scrollFix", new ScrollFix(this.get("tocEl"))), b.on("touchstart", function(a)
            {
                h = a.originalEvent.changedTouches[0].pageX, i = a.originalEvent.changedTouches[0].pageY
            ...
            var k = function(b)
            {
                ...
                g = k || l || m ? g.parentElement : g, g = m ? g.parentElement : g;
                var n = f.contains(g, "section") && "A" === g.tagName,
                    o = !n && "A" === g.tagName;
                if (n) e.toggleSection(g);
                else if (o && g.getAttribute("href"))
                {
                    j.get("controller")
                        .hidePanels();
                    var p = g.getAttribute("href");
                    p.match(/^help:/) ? window.location = p : (e.selectItem(g), window.location.hash = p), p && -1 !== p.indexOf("#/") && (p = p.split("#/")[1]), j.get("controller.trackingController")
                        .tocSelect(p)
                }
                return !1
            };
            b.on("touchend", k), b.on("click", k), this.get("tabIndexManager")
                .domReady()
        },
        willDestroyElement: function()
        {
            var a = this.$();
            g.get("isMobile") && (this.get("scrollFix")
                .destroy(), a.off("touchstart"), a.off("click")), a.off("touchend"), a.off("click")
        },
        scrollActiveItemIntoView: function()
        {
            var a = this.get("activeItem")
                .offsetTop,
                b = this.get("activeItem")
                .offsetHeight,
                c = this.get("tocEl"),
                d = c.offsetHeight,
                e = c.scrollTop,
        ...
        currentTopicObserver: function()
        {
            ...
            c && e.deselectItem(c), b && (e.selectItem(b), this.set("activeItem", b), this.set("tabIndexManager.axFocus", b), b.blur(), Ember.run.debounce(this, this.scrollActiveItemIntoView, this.get("scrollTimeout")))
        ...
        keyDown: function(a)
        {
            ...
            {
                case d:
                    this.tabIndexToPrevious(), a.preventDefault();
                    break;
                case e:
                    this.tabIndexToNext(), a.preventDefault();
                    break;
                case f:
                    i(b) ? b.click(a) : this.tabIndexToSection(), a.preventDefault();
                    break;
                case g:
                    b && b.click(a), a.preventDefault();
                    break;
                default:
                    this._super(a)
            }
        ...
        tabIndexToPrevious: function()
        {
            var a = this.get("tabIndexManager"),
                b = a.get("axFocus"),
                c = l(b);
            if (!c) return void this.tabIndexToSection();
        ...
        tabIndexToNext: function()
        {
            ...
            var d = m(b);
            for (candidate = j(b); !d && candidate;) d = m(candidate), candidate = j(candidate);
            d && a.set("axFocus", d)
        }
    })
    ...
    return Ember.HTMLBars.template(function()
    {
        return {
            ...
            build: function(a)
            {
                ...
                a.setAttribute(c, "action", "//wsidecar.apple.com/cgi-bin/fb_hlp/nph-sub/"), a.setAttribute(c, "method", "post"), a.setAttribute(c, "name", "feedback");
                var d = a.createTextNode("\n  ");
                a.appendChild(c, d);
                var d = a.createElement("input");
                a.setAttribute(d, "type", "hidden"), a.setAttribute(d, "name", "topicID"), a.appendChild(c, d);
                var d = a.createTextNode("\n  ");
                a.appendChild(c, d);
                var d = a.createElement("input");
                a.setAttribute(d, "type", "hidden"), a.setAttribute(d, "name", "topicName"), a.appendChild(c, d);
                var d = a.createTextNode("\n  ");
                a.appendChild(c, d);
                var d = a.createElement("div");
                ...
                a.setAttribute(f, "type", "radio"), a.setAttribute(f, "name", "choice"), a.setAttribute(f, "value", "yes"), a.appendChild(e, f);
                var f = a.createTextNode(" ");
                a.appendChild(e, f);
                var f = a.createComment("");
                a.appendChild(e, f), a.appendChild(d, e);
                ...
                var e = a.createElement("label"),
                    f = a.createElement("input");
                a.setAttribute(f, "type", "radio"), a.setAttribute(f, "name", "choice"), a.setAttribute(f, "value", "somewhat"), a.appendChild(e, f);
                var f = a.createTextNode(" ");
                a.appendChild(e, f);
                var f = a.createComment("");
                a.appendChild(e, f), a.appendChild(d, e);
                ...
                var e = a.createElement("label"),
                    f = a.createElement("input");
                a.setAttribute(f, "type", "radio"), a.setAttribute(f, "name", "choice"), a.setAttribute(f, "value", "no"), a.appendChild(e, f);
                var f = a.createTextNode(" ");
                a.appendChild(e, f);
                var f = a.createComment("");
                a.appendChild(e, f), a.appendChild(d, e);
                ...
                a.setAttribute(e, "name", "comments"), a.appendChild(d, e), a.appendChild(c, d);
                var d = a.createTextNode("\n  ");
                a.appendChild(c, d);
            ...
            render: function(a, b, c)
            {
                ...
                d.detectNamespace(c);
                var m;
                b.useFragmentCache && d.canClone ? (null === this.cachedFragment && (m = this.build(d), this.hasRendered ? this.cachedFragment = m : this.hasRendered = !0), this.cachedFragment && (m = d.cloneNode(this.cachedFragment, !0))) : m = this.build(d);
                var n = d.childAt(m, [0]),
                    o = d.childAt(n, [3]),
                    p = d.childAt(m, [2]),
                    q = d.childAt(m, [4]),
                ...
                {})])), i(b, F, r, "value", h(b, [f(b, a, "view.topicID")])), i(b, G, s, "value", h(b, [f(b, a, "view.topicName")])), l(b, H, a, "view.choiceAffirmativeText"), l(b, I, a, "view.choiceTentativeText"), l(b, J, a, "view.choiceNegativeText"), j(b, K, a, "loc", ["$FEEDBACK_COMMENT_LABEL$"],
...
}), define("feedback/view", ["precompiled/feedback/template", "shared/browser", "shared/computed"], function(a, b, c)
{
    return Em.View.extend(
    {
        ...
        topicName: function()
        {
            return $("h1", this.get("parentView.content.template"))
                .text()
        }.property("parentView.content.template"),
        click: function(a)
        {
            a.stopPropagation(), this.set("selectedChoice", this.$("input[name=choice]:checked")
                .val())
        },
        actions:
        {
            showForm: function()
            {
                this.set("isExpanded", !0), this.$("button[name=submit]")
                    .focus()
            },
            hideForm: function()
            {
                this.set("isExpanded", !1), this.$(".solicit a")
                    .focus()
            },
            submitForm: function()
            {
                var a, c, d = this.get("selectedChoice");
                a = null === this.get("app.ENVIRONMENT") ? this.$("form")
                    .attr("action") : "localhost", c = {
                        helpValue: d,
                    ...
                    }, $.ajax(a,
                    {
                        ...
                        dataType: "jsonp",
                        jsonp: !1
                    }), this.set("isSubmitted", !0), this.get("app.trackingController")
                    .feedbackSubmit(d), this.send("hideForm")
            }
        }
    })
}), define("translations", [], function()
{
    var a = {
        ...
        hr:
        {
            ...
            $TOPIC_LOAD_ERROR$: "Odabrana tema trenutno nije dostupna",
        ...
        ru:
        {
            ...
            $PREV_TOPIC_BUTTON_LABEL_SHORT$: "Ранее",
        ...
        "zh-hk":
        {
            ...
            $CONNECT_TO_INTERNET$: "<p>請確定你已連接互聯網。如需要協助連線，請選擇「蘋果」選單 >「系統偏好設定…」，按一下網路，然後按一下「協助我…」。</p><p>若你已連接互聯網，但仍無法顯示內容，請稍後再試。</p>",
            $TOC_MORE_HELP$: "更多 Mac <span class='nb'>的輔助說明%@</span>",
...
}), define("app", ["shared/app", "app/controller", "app/view", "header/view", "topic/view", "topic/route", "search/view", "toc/view", "shared/computed", "locale/select-view", "feedback/view", "shared/browser", "translations", "shared/base/controller"], function(a, b, c, d, e, f, g, h, i, j, k, l, m, n)
{
    ...
    return window.App = o.create(), window.App
}), require(["app"]);